...
def generate_table_csv(n):
   ...
   for i in range(i, i + n):
      ...
      data.append({
            ...
            'app_amount_requested' : random.randint(500000, 1000000),
...
# Generate the data
df_inactive = generate_table_csv(966)

# Save to CSV
csv_filename = "fixed_investor.csv"

df_inactive.to_csv(csv_filename, index=False)

print(f"CSV saved as: {'fixed_investor'}")
