...
export_csv = 'aggre_db_loan_applications.csv' 
path = 'Aggre_2_Files_Github/Aggre_2_Generated CSV files' 
output_file = os.path.join(path,export_csv)
df.to_csv(output_file, index = False)

#os.path.join('aggre_db_SQL_scripts') 
print(f"CSV saved as:{'Loan Applications'}")